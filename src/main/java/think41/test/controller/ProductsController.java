...
import think41.test.service.ProductMigrationService;
...
public class ProductsController {
	...
	public ResponseEntity<ResponseStructure<Page<Products>>> getPage(@PathVariable int pageNumber, @PathVariable int pageSize){
		return new ResponseEntity<ResponseStructure<Page<Products>>>(productsService.getPage(pageNumber,pageSize), HttpStatus.OK);
	}
	...
	public String updateDB() {
		productMigrationService.migrateDepartmentsToForeignKey();
